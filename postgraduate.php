...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Cantor college's postgraduate courses">
    </head>
    <body>
        <?php
        ...
        <main>
            ...
            <section class="body-content">
                <div class="body-content-containers">
                    <div class="postgraduate-courses-container">
                        <h1 class="container-title">Postgraduate courses</h1>
                        <hr class="line-separator">
                        <div>
                            <?php
                                $sql = "SELECT * FROM course_list WHERE CourseType = 'Postgraduate'";
                                $result = mysqli_query($mysqli, $sql);
                                $queryResults = mysqli_num_rows($result);
            
                                if($queryResults > 0){
                                    while($row = mysqli_fetch_assoc($result)){
                                        echo"<div class='course-details-container'>
